...
public class arraysStepDefinition {
	private static final Logger logger = LogManager.getLogger(arraysStepDefinition.class);
	loginpage lp;
	homePage hp;
	arraysPage ap;
//	practicePage pp;
//	textEditor teditor;
	...
	public void user_clicks_on_link(String topiccoveredlink) {
		ap.topicsCovered(topiccoveredlink);
	...
	public void user_should_be_redirected_to_page(String expected_pagetitle) {
		...
		String actual_pagetitle=ap.fetchtitlepage();
		Assert.assertEquals(actual_pagetitle,expected_pagetitle, "does not match. Expected: " + expected_pagetitle + " but found: " + actual_pagetitle);
	}
	...
	public void text_editor_should_be_displayed() {
	   ...
	   Assert.assertTrue( ap.textEditorIsDisplayed());
	   
	}

	@Given("user is on text editor page for corresponding {string} page")
	public void user_is_on_text_editor_page_for_corresponding_page(String topiccoveredlink) {
		ap.topicsCovered(topiccoveredlink);
		ap.tryhere();
	...
	public void user_enters_python_code_and_clicks_run_button() {
		...
		try {
			...
			System.out.println("Arraycode is " + Arraycode);
		} catch (Exception e) {
		...
		if (Arraycode != null) {
			...
			ap.runPythonCode(Arraycode.get("Code"));
	...
	public void user_is_on_applications_of_array_page() {
		ap.topicsCovered("Applications of Array");
	...
	public void user_is_on_practice_questions_page() {
	 ...
	 public void user_clicks_on_the_link(String practiceQuestiontopic) {
		 ap.practicesubTopiclink(practiceQuestiontopic);
	 }
	 ...
	 public void user_should_be_navigated_to_the_page(String expectedTitle) {
		 String actualTitle = ap.subtopicTitle();
