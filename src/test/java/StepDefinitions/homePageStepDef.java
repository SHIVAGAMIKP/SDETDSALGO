...
public class homePageStepDef {
	...
	public void user_should_navigate_to_home_page() {
		...
		Assert.assertEquals(hp.fetchTitle(), "NumpyNinja");
	}
	...
	public void the_user_get_warning_message(String expectedMsg) {
		// logger.info("verifying error message when cliking on dropdown without
		// signin");
	...
	public void user_should_be_navigating_to_the_corresponding_introduction_page(
		...
		// logger.info("verifying corresponding introduction cliking on dropdown
		// after signin");
		logger.info(
