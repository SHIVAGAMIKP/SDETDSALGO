...
//	@FindBy(css = "div.question h2")
    ...
    public String subtopicTitle()
    {
        ...
        WebElement titleElement = wait.until(
            ExpectedConditions.visibilityOf(practicesubTopicsTitle));
        String titleText = titleElement.getText();
    	System.out.print("Title "+titleText); 
    	return titleText;
    }
//    public String practiceQuefetchTitle()
//    {
//    	String questionpagetitle= practicesubTopicsTitle.getText();
//    	System.out.print(questionpagetitle);
